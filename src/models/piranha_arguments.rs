...
use super::{
  default_configs::{
    ...
    default_rule_graph, default_substitutions, GO, JAVA, KOTLIN, PHP, PYTHON, RUBY, SWIFT, TSX,
    TYPESCRIPT,
  },
...
pub struct PiranhaArguments {
  ...
  #[clap(short = 'l', value_parser = clap::builder::PossibleValuesParser::new([JAVA, SWIFT, PYTHON, PHP, KOTLIN, GO, TSX, TYPESCRIPT, RUBY])
